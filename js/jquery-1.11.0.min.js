/*! jQuery v1.11.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function(a, b) {
        ...
        (db.matchesSelector = function(a, b) {
            if (
                ((a.ownerDocument || a) !== l && k(a),
                    (b = b.replace(S, "='$1']")), !(!c.matchesSelector || !n || (p && p.test(b)) || (o && o.test(b))))
            )
                try {
                    var d = q.call(a, b);
                    if (
        ...
        trigger: function(b, c, d, e) {
            ...
            if (
                ...
                if (!e && !k.noBubble && !n.isWindow(d)) {
                    for (
                        i = k.delegateType || p, _.test(i + p) || (h = h.parentNode); h; h = h.parentNode
                    )
                        o.push(h), (l = h);
                    l === (d.ownerDocument || z) &&
    ...
    n.extend({
            ...
            buildFragment: function(a, b, c, d) {
                for (
                    var e, f, g, h, i, j, k, m = a.length, o = eb(b), p = [], q = 0; m > q; q++
                )
                    if (((f = a[q]), f || 0 === f))
        ...
        n.fn.extend({
            ...
            domManip: function(a, b) {
                ...
                if (
                    ...
                    if (f)
                        for (
                            h = g[g.length - 1].ownerDocument, n.map(g, zb), j = 0; f > j; j++
                        )
                            (d = g[j]),
                            pb.test(d.type || "") &&
    ...
    function ic(a, b, c) {
        for (
            var d, e = (fc[b] || []).concat(fc["*"]), f = 0, g = e.length; g > f; f++
        )
